...
支持多模态量化策略指导，用户可通过自然语言描述投资逻辑，系统自动生成可直接运行的量化策略代码，显著降低量化交易参与门槛，使非编程背景用户也能独立完成策略开发与回测。策略代码生成成功率与可用性处于行业领先水平。
...
- **量化知识库 + 多模态问答**：严格根据量化知识库，对于量化相关问题，图文并茂回复，让用户便于理解与操作
