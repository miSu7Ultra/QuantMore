...
```bash
# 运行单元测试
./gradlew test --tests "com.quantmore.infrastructure.file.DocumentParseServiceTest"

# 运行集成测试
./gradlew test --tests "com.quantmore.infrastructure.file.DocumentParseIntegrationTest"
```
