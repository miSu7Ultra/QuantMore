 ...
 *
 * <p>真实场景下：UI 上点 "测试连接" 走的是 {@link com.quantmore.modules.llmprovider
 * .service.LlmProviderConfigService#testProvider}（自己拼路径，所以 OK），但其他调用
...
class LlmProviderRegistryPathIntegrationTest {
  ...
  private LlmProviderRegistry buildRegistryFor(String baseUrl) {
    ...
    return new LlmProviderRegistry(properties, toolCallingManager, null);
  }
